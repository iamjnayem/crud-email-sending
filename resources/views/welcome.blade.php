			...
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="{{route('download')}}" class="btn btn-danger" ><i class="material-icons">&#xE15C;</i> <span>Download All Student</span></a>						
					</div>
				</div>
			</div>
			...
			<form method="POST" action="{{route('students.store')}}">
				...
				<div class="modal-body">					
					...
					<div class="form-group">
                        ...
                        <select name="departments" id="departments" class="p-2">
        ...
        <form>
				...
				<div class="modal-body">					
                    ...
                    <div class="form-group">
                        ...
                        <input type="checkbox" id="s1" name="subject" value="Bangla">
                        <label for="s1"> Bangla</label><br>
                        <input type="checkbox" id="s2" name="subject" value="English">
                        <label for="s2">English</label><br>
                    </div>
